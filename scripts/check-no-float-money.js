...
// Fails if parseFloat / Math.round / Math.floor / Math.ceil appear near
// money identifiers: amount|prize|payout|balance|wei|gen
const fs = require('fs');
...
function runCheck() {
  ...
  const moneyRegex = /amount|prize|payout|balance|wei|gen/i;
